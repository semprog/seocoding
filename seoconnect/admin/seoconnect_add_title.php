...
if($back_url == '')
$back_url = '/bitrix/admin/seoconnect_list_titles.php?lang='.LANG;
...
$aContext = array(
	array(
		...
		"LINK"=>"seoconnect_list_titles.php?lang=".LANG,
...
if(($_POST['saveForm'] == 'Y') && check_bitrix_sessid())
{
	...
	else
	{
		$DB->Commit();
       if($_POST['apply']) {
         LocalRedirect("/bitrix/admin/seoconnect_add_title.php?lang=".$lang."&ID=".urlencode($ID)."&"."&".$tabControl->ActiveTabParam());
       } else {
...
?>
	...
	<tr>
		...
		<td><input type="text" name="TITLE" size="50" value="<?=$str_TITLE?>"></td>
	</tr>
